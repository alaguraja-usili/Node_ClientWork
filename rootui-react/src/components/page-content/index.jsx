...
class PageContent extends Component {
    ...
    render() {
        ...
        return (
            <>
                <div className="rui-page-content rui-scrollbar" style={ { maxHeight: "calc(100vh - 70px)" } }>
                    { content }
                </div>
                { /* <footer className="rui-footer" style={ { height: "70px", width: "100%", paddingTop: "16px" } }>
                    <Row className="justify-content-md-center">
                        <Col xs={ 7 }>
                            <Input type="name" name="name" id="nameInput1" placeholder="Name" />
                        </Col>
